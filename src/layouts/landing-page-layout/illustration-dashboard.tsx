...
export default function IllustrationDashboard() {
  return (
    <svg
      id="cb7db7bb-371f-430c-ab8e-9f8547f8cfe6"
      data-name="Layer 1"
      className="w-full object-cover mt-8 mx-auto max-w-screen-xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28"
    ...
    >
      ...
      <path
        ...
        opacity="0.1"
      />
      <ellipse cx="499.98" cy="855.15" rx="289.98" ry="12.94" fill="#38b2ac" opacity="0.1" />
      <path
      ...
      <rect x="221.98" y="205.48" width="101.33" height="9.33" fill="#38b2ac" />
      <rect x="221.98" y="250.98" width="101.33" height="9.33" fill="#38b2ac" opacity="0.5" />
      <rect x="221.98" y="283.15" width="101.33" height="9.33" fill="#38b2ac" opacity="0.5" />
      <rect x="221.98" y="315.32" width="101.33" height="9.33" fill="#38b2ac" opacity="0.5" />
      <rect x="221.98" y="347.48" width="101.33" height="9.33" fill="#38b2ac" opacity="0.5" />
      <rect x="221.98" y="379.65" width="101.33" height="9.33" fill="#38b2ac" opacity="0.5" />
      <rect x="221.98" y="411.82" width="101.33" height="9.33" fill="#38b2ac" opacity="0.5" />
      <rect x="221.98" y="443.98" width="101.33" height="9.33" fill="#38b2ac" opacity="0.5" />
      ...
      <path
        ...
        fill="#38b2ac"
      />
      <circle cx="647.55" cy="275.37" r="11.13" fill="#38b2ac" />
      <path
      ...
      <ellipse cx="952.73" cy="801.29" rx="26.93" ry="4.55" fill="#38b2ac" opacity="0.1" />
      <ellipse cx="115.22" cy="858.74" rx="26.93" ry="4.55" fill="#38b2ac" opacity="0.1" />
      <ellipse cx="893.79" cy="850.05" rx="40.21" ry="6.8" fill="#38b2ac" />
      <path
